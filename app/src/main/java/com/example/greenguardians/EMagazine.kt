...
import com.example.greenguardians.databinding.ActivityEmagazineBinding
...
class EMagazine : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityEmagazineBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityEmagazineBinding.inflate(layoutInflater)
        enableEdgeToEdge()
        setContentView(binding.root)
        val gridLayoutManager = GridLayoutManager(this@EMagazine, 1)
        binding.RecyclerVw19f19478EM.layoutManager=gridLayoutManager
        val builder = AlertDialog. Builder ( this@EMagazine)
        ...
        dtlst = ArrayList()
        adapter = AdapterMagazine(this@EMagazine, dtlst)
        binding.RecyclerVw19f19478EM.adapter=adapter
        ...
        binding.Magazinebtn.setOnClickListener{
            val intent = Intent(this, MagazineUploadPage::class.java)
