...
class UpldActSup : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val outcome = registerForActivityResult<Intent, ActivityResult>(
            ...
            if (result.resultCode == RESULT_OK) {
                ...
                Toast.makeText(this@UpldActSup, "Failed to Select An Image", Toast.LENGTH_SHORT)
                    .show()
            }
        }
    ...
    private fun dta_apld() {
        ...
        val dtR= FirebaseDatabase.getInstance().getReference("OmanGreenGuardians").child(Title19f19478)
            .setValue(DtaCls).addOnSuccessListener{ Toast.makeText(this@UpldActSup, "Data are Saved", Toast.LENGTH_SHORT).show()
                finish()
            }.addOnFailureListener() { e -> Toast.makeText(this@UpldActSup, e.message.toString(), Toast.LENGTH_SHORT).show()}
    }
    private fun data_save() {
        ...
        val blrdr = AlertDialog.Builder(this@UpldActSup)
